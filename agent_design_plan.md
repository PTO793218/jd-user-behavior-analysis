...
`data_loader.py`：读取 `jd_analysis_final.csv`、`jd_rfm_result.csv`、`comment_word_freq.csv`，统一处理路径和缓存。
...
`README_agent.md`：说明如何运行、能问什么问题、项目亮点和简历写法。
